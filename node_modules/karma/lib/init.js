...
var questions = [{
  ...
  hint: 'This will generate test-start.js/coffee that configures RequireJS and starts the tests.',
  options: ['no', 'yes'],
  boolean: true,
  ...
  hint: 'This should be a script that bootstraps your test by configuring Require.js and ' +
        'kicking __karma__.start(), probably your test-start.js file.\n' +
        'Enter empty string to move to the next question.',
  multiple: true,
  validate: validatePattern,
  condition: function(answers) {
...
exports.init = function(config) {
  ...
  sm.process(questions, function(answers) {
    ...
    var testMainFile = isCoffee ? 'test-main.coffee' : 'test-start.js';
